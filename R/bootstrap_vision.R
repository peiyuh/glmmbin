#' Bootstrap for binomial (For Vision (closed & open & dome))
#'
...
#' @examples
#' ## CTSIB ##
#' bootstrap_fit <- bootstrap_vision(100,data)
bootstrap_vision <- function(B, data, para){
